...
var restaurants = [
    ...
    {name: 'Kebab Express', latitude: 45.4966171, longitude: -73.5789917, status: Status.Unsafe, numViolations: 2},
    ...
    {name: 'Mr. Puffs', latitude: 45.4963141, longitude: -73.5787252, status: Status.Unsafe, numViolations: 1},
    ...
    {name: 'Pizza Hut', latitude: 45.4971162, longitude: -73.57719790, status: Status.Unsafe, numViolations: 9},
    {name: 'Tim Hortons', latitude: 45.4959818, longitude: -73.5796559, status: Status.Unsafe, numViolations: 4},
    ...
    {name: 'Subway', latitude: 45.4959022, longitude: -73.5802646, status: Status.Unsafe, numViolations: 1},
    ...
    {name: 'Burger King', latitude: 45.4948231, longitude: -73.5782987, status: Status.Unsafe, numViolations: 7},
    {name: 'Java U', latitude: 45.4957981, longitude: -73.5790314, status: Status.Safe, numViolations: 0},
    {name: 'Thaï Express', latitude: 45.4958800, longitude: -73.5789809, status: Status.Unsafe, numViolations: 3},
    {name: 'Pizza Bella', latitude: 45.4958670, longitude: -73.5788498, status: Status.Unsafe, numViolations: 5},
